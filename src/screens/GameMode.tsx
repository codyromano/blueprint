    ...
    >
      <Grid container>
        <Grid xs={12} textAlign={"center"} marginBottom="0.5rem">
          ...
          <Typography variant="caption">Each perk has pros and cons</Typography>
        </Grid>
        ...
        <Grid xs={4}  display={"flex"} className="game-mode-item" flexDirection={"column"}>
          ...
          <Typography variant="caption">Your house guests are easier to please, but you have high standards; art and furniture cost more.</Typography>
        </Grid>
        <Grid xs={4}  display={"flex"} className="game-mode-item" flexDirection={"column"}>
         <Typography variant="h5" textAlign={"center"}>Diva</Typography>
          ...
          <Typography variant="caption">You're rich, but your wits get you into trouble; puzzles are significantly harder.</Typography>
        </Grid>
